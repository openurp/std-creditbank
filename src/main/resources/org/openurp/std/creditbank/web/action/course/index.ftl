  ...
  <div class="search-container">
    <div class="search-panel">
        [@b.form title="ui.searchForm" name="searchForm" action="!search" target="grades" theme="search"]
          ...
          [@b.textfields names="grade.std.code;学号,grade.std.name;姓名,grade.std.state.grade;年级,grade.std.state.department.name;学院名称,grade.std.state.squad.code;班级代码,grade.std.state.squad.name;班级名称,grade.course.code;课程代码,grade.course.name;课程名称"/]
        [/@]
    </div>
